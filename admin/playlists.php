...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="../css/admin_style.css?version=1" />
...
<section class="playlists">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <div class="flex">
            <div><i class="fas fa-circle-dot" style="<?php if($fetch_playlist['status'] == 'active'){echo 'color:limegreen'; 
            }else{echo 'color:red';
            }
             ?>"></i><span style="<?php
            ...
            <div><i class="fas fa-calendar"></i><span>2023-08-21</span></div>
            <!-- <?= $fetch_playlist['date']; ?> -->
         </div>
         <div class="thumb">
